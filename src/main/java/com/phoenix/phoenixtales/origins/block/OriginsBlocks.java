...
public class OriginsBlocks {
    ...
    public static final Block HUO_LEAVES = createBlock("huo_leaves", new OriginsLeavesBlock(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT).notSolid().setLightLevel(BlockState -> 5).setSuffocates(OriginsBlocks::isntSolid).setBlocksVision(OriginsBlocks::isntSolid)));
    ...
    public static final Block HUI_LEAVES = createBlock("hui_leaves", new OriginsLeavesBlock(AbstractBlock.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT).notSolid().setLightLevel(BlockState -> 5).setSuffocates(OriginsBlocks::isntSolid).setBlocksVision(OriginsBlocks::isntSolid)));
