...
public class SurfaceFeature extends Feature<NoFeatureConfig> {
    private final BlockState stone = OriginsBlocks.SMOULDERING_STONE.getDefaultState();
    ...
    public boolean generate(ISeedReader reader, ChunkGenerator generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        ...
        reader.setBlockState(pos1, this.stone, 2);
        Random r = new Random();
        //north
        BlockPos pos2 = pos1;
        ...
        for (int i = 0; i < count; i++) {
            ...
            reader.setBlockState(pos3, this.stone, 2);
            int amount = r.nextInt(5);
            for (int j = 0; j < amount; j++) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            reader.setBlockState(pos4, this.stone, 2);
            int amount = r.nextInt(5);
            for (int j = 0; j < amount; j++) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            reader.setBlockState(pos5, this.stone, 2);
            int amount = r.nextInt(5);
            for (int j = 0; j < amount; j++) {
