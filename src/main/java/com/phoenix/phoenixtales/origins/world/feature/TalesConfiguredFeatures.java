...
public class TalesConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ASHEN_TALL_GRASS = createConfiguredFeature("ashen_tall_grass", Feature.RANDOM_PATCH.withConfiguration(TalesFeatures.Configs.ASHEN_TALL_GRASS_CONFIG).withPlacement(Features.Placements.VEGETATION_PLACEMENT).withPlacement(Features.Placements.FLOWER_TALL_GRASS_PLACEMENT).square().withPlacement(Placement.COUNT_NOISE.configure(new NoiseDependant(-0.8D, 0, 7))));
