...
public class TalesSurfaceBuilders {
    ...
    public static class Configs {
        public static final SurfaceBuilderConfig ASHEN_PLAINS = new SurfaceBuilderConfig(OriginsBlocks.SEARING_STONE.getDefaultState(), OriginsBlocks.SEARING_STONE.getDefaultState(), OriginsBlocks.SEARING_STONE.getDefaultState());
    }
}
