...
public enum Ores {
    OVERWORLD_NICKEL(RiseBlocks.ORE_NICKEL, 3, 0, 60, 4),
    OVERWORLD_VANADIUM(RiseBlocks.ORE_VANADIUM, 3, 0, 60, 4),
    OVERWORLD_KERNITE(RiseBlocks.ORE_KERNITE, 3, 40, 90, 2),
    OVERWORLD_APATITE(RiseBlocks.ORE_APATITE, 3, 40, 90, 2),
