...
public class EnergyStoreContainer extends Container {

    private final EnergyStoreTile tile;
    private final PlayerEntity player;
    private final IItemHandler playerInv;
    private final BlockPos pos;

    public EnergyStoreContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(RiseContainers.ENERGY_STORE_CONTAINER, windowId);

        this.pos = pos;

        if (world.getTileEntity(pos) instanceof EnergyStoreTile) {
            this.tile = (EnergyStoreTile) world.getTileEntity(pos);
        } else {
            this.tile = null;
        }
...
//        });
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tile.getWorld(), tile.getPos()), playerIn, RiseBlocks.ENERGY_STORE);
    }
