...
import com.phoenix.phoenixtales.rise.block.blocks.cable.PhoenixCable;
...
public class RiseBlocks {
    ...
    public static final Block PHOENIX_CABLE = createBlock("phoenix_cable", new PhoenixCable());
