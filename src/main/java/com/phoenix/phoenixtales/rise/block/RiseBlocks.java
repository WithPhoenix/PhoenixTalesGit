...
import com.phoenix.phoenixtales.rise.block.blocks.cable.ImprovedCable;
...
import com.phoenix.phoenixtales.rise.block.blocks.htfactory.HTFactory;
...
import com.phoenix.phoenixtales.rise.block.blocks.pipe.Pipe;
...
public class RiseBlocks {
    ...
    public static final Block ORE_COPPER = createBlock("copper_ore", new Block(AbstractBlock.Properties.create((Material.ROCK), MaterialColor.LIGHT_GRAY).hardnessAndResistance(3f, 3f).harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.STONE).setRequiresTool()));
    ...
    public static final Block BLOCK_COPPER = createBlock("copper_block", new Block(AbstractBlock.Properties.create((Material.IRON), MaterialColor.GRAY).hardnessAndResistance(5f, 6f).harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.METAL).setRequiresTool()));
    public static final Block BLOCK_TIN = createBlock("tin_block", new Block(AbstractBlock.Properties.create((Material.IRON), MaterialColor.GRAY).hardnessAndResistance(5f, 6f).harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.METAL).setRequiresTool()));
    ...
    public static final Block ADVANCED_CABLE = createBlock("advanced_cable", new ImprovedCable());
    public static final Block OVERLOADED_CABLE = createBlock("overloaded_cable", new OverloadedCable());
    public static final Block PIPE = createBlock("pipe", new Pipe());
    ...
    public static final Block HT_FACTORY = createBlock("ht_factory", new HTFactory());
