...
//        this.energyField = new EnergyField(this.guiLeft + 167, this.guiTop + 5, 3, 75,null, this.tile.getEnergyStorage());
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        if (mouseX >= guiLeft + 166 && mouseY >= this.guiTop + 4 && mouseX < guiLeft + 166 + 5 && mouseY < guiTop + 4 + 77) {
            this.renderTooltip(matrixStack, new StringTextComponent(tile.getEnergy() + "/" + tile.getMax() + "J"), mouseX, mouseY);
        }
    }
